...
function PenawaranIllustration() {
  return (
    <div className="relative">
      ...
      {/* Toast notification */}
      <div className="absolute -bottom-4 left-0 sm:-left-4 bg-white rounded-xl shadow-lg border border-gray-100 px-4 py-3 flex items-center gap-3">
      ...
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl lg:text-6xl font-extrabold leading-tight tracking-tight text-gray-900 mb-5">
